...
class ControllerExtensionModuleWhatsmastermsg extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/whatsmastermsg', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/module/whatsmastermsg', 'token=' . $this->session->data['token'], true);
